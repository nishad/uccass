<?php
     ...
     *	@version	$Id: mock_objects.php,v 1.1 2006/01/09 15:11:38 malyvelky Exp $
     */
    ...
    class SimpleMock extends SimpleStub {
        ...
        function _checkExpectations($method, $args, $timing) {
            ...
            }	//echo "_checkExpectations - is: $method, ({$args[0]}) at $timing; "; print_r($this->_expected_args_at[$timing][$method]->_expected);echo '<br>';
