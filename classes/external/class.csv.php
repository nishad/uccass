 ...
 * @author Jakub Holy - small modifications for uccass
 * @license BSD or LGPL 
 * @version 1.1b (2005_10_26) 
 * url: phpclasses.org/browse/package/2672.html
 */
...
class csv
{
	...
	Function csv($file, $seperator = ',', $enclose = '"', $escape = ''){
		...
		// Open file 
		$this->mHandle = @fopen($file, "r") or trigger_error("Unable to open the csv file '$file'", E_USER_ERROR);
	}
	...
	/**
	 * Close the csv file (opened in the constructor).
	 * After calling this do not try any other operation on the already closed
	 * file, such as NextLine()!
