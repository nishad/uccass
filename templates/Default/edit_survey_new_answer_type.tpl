      ...
      <form method="POST" action="{$conf.html}/new_answer_type.php">
        ...
        <div class="indented_cell">
          ...
          <select name="type" size="1">
            ...
            <option value="MS"{$selected.MS}>MS</option>
            <option value="MM"{$selected.MM}>MM</option>
            <option value="N"{$selected.N}>N</option>
          </select>
        </div>
        ...
        <div style="text-align:center">
          <br />
          <input type="submit" name="submit" value="Add Answer"></td>
        </div>
